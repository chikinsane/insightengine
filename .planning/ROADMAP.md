...
Plans:
- [ ] 02-01-PLAN.md — Dependencies, Vitest, type contracts, ingestion engine (CSV/Excel parsers, schema inference)
- [ ] 02-02-PLAN.md — AI query engine (DuckDB client, SQL validator, NL-to-SQL, enrichment pipeline)
- [ ] 02-03-PLAN.md — Upload API + dataset CRUD + schema preview/confirm UI
- [ ] 02-04-PLAN.md — Query API + chart renderer + insight panel + follow-up chips
- [ ] 02-05-PLAN.md — Dashboard integration + end-to-end verification checkpoint
...
|-------|-----------|----------------|--------|-----------|
| 1. Foundation | v1 | 3/3 | Complete | 2026-03-17 |
| 2. Core AI Loop | 1/5 | In Progress|  | - |
